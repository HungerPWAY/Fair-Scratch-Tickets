...
def parse_arguments():
    ...
    parser.add_argument(
        "--groups_network_arch", default="FC_adv"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--adv_warmup_length", default=0, type=int, help="Number of warmup iterations"
    )
    parser.add_argument(
        "--momentum", default=0.9, type=float, metavar="M", help="momentum"
    )
    parser.add_argument(
        "--adv-momentum", default=0.9, type=float, metavar="M", help="momentum"
    )
    ...
    parser.add_argument(
        ...
        type=float,
        metavar="W",
        help="adv weight decay (default: 1e-4)",
        dest="adv weight_decay",
    )
    parser.add_argument(
        "-p",
        "--print-freq",
    ...
    parser.add_argument(
        "--lr-policy-targets", default="constant_lr", help="Policy for the learning rate."
    )
    parser.add_argument(
        "--lr-policy-groups", default="constant_lr", help="Policy for the learning rate."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--first-layer-dense-adv", action="store_true", help="First layer dense or sparse"
    )
    parser.add_argument(
        "--last-layer-dense", action="store_true", help="Last layer dense or sparse"
    )
    parser.add_argument(
        "--layer-dense-adv", action="store_true", help="First layer dense or sparse"
    )
    parser.add_argument(
        "--label-smoothing",
        type=float,
    ...
    parser.add_argument(
        "--ft-init", default="kaiming_normal", help="Weight initialization modifications"
    )
    parser.add_argument("--fair-regularization", type = str, default ="-1" , help = "the type of fair regularization")
    parser.add_argument("--lam-fair", type = float, default = 0)

    parser.add_argument("--fair-type", type = str, default = None)
    ...
    parser.add_argument("--automatic-resume", action="store_true")
    parser.add_argument("--random-ticket", action="store_true")
    parser.add_argument("--adv", action = "store_true")
    parser.add_argument("--adv_training_ratio", type = int, default= 3)
    parser.add_argument("--alpha", type = float, default= 1)
    parser.add_argument("--subset-percentage", type = float, default= 1)
    parser.add_argument("--protected-percentage", type = float, default= 0.1)
    parser.add_argument("--lambd", type = float, default= 50)
    parser.add_argument("--balance-protected", action = "store_true")
