...
def ResNet3(pretrained=False):
    return ResNet(get_builder(), BasicBlock, [1, 0, 0, 0], 1)

def ResNet4(pretrained=False):
    return ResNet(get_builder(), BasicBlock, [1, 1, 0, 0], 1)

def ResNet6(pretrained=False):
    return ResNet(get_builder(), BasicBlock, [1, 1, 1, 1], 1)
...
def ResNet34(pretrained=False):
    return ResNet(get_builder(), BasicBlock, [3, 4, 6, 3], 1)

def ResNet50(pretrained=False):
    return ResNet(get_builder(), Bottleneck, [3, 4, 6, 3], 1)
...
def WideResNet50_2(pretrained=False):
    return ResNet(
        get_builder(), Bottleneck, [3, 4, 6, 3], num_classes=1, base_width=64 * 2
    )
