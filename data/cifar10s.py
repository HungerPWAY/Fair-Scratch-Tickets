...
class CIFAR_10S(VisionDataset):
    ...
    def __getitem__(self, index):
        ...
        return image, np.int64(label), np.float32(color)

    def _make_skewed(self, split='train', seed=0, skewed_ratio=1., num_classes=10):

        train = False if split =='test' else True
        cifardata = CIFAR10('/home/tangpw/Fair-Feature-Distillation-for-Visual-Recognition/data/', train=train, shuffle=True, seed=seed, download=True)
